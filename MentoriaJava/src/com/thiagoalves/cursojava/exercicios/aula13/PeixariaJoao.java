...
public class PeixariaJoao {
	...
	public static void main(String[] args) {
		...
		if (pesoPeixe > pesoMaximo) {
			...
			System.out.println("Seu peixe excedeu " + pesoExcedente + "kg. O valor da multa é de: R$ " + valorMulta);
			
		} else {
			System.out.println("Seu peixe pesa " + pesoPeixe + "kg. Você não excedeu o peso máximo de " + pesoMaximo +
					"kg e não tem multa a pagar.");
		}
