...
public class CalculoInteiroReal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Infome um número real: ");
		double numeroReal = numero.nextDouble();
		
		numero.close();
		
		int resultado1 = (primeiroNumero * 2) + (segundoNumero / 2);		
		System.out.println("O dobro do primeiro com metade do segundo é igual a: " + resultado1);
		
		double resultado2 = (primeiroNumero * 3) + numeroReal;		
		System.out.println("A soma do triplo do primeiro com o terceiro é igual a: " + resultado2);
