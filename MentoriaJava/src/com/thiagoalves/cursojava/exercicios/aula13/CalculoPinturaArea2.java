...
public class CalculoPinturaArea2 {
	...
	public static void main(String[] args) {
		...
		//Informa lata grande
		System.out.println("Em latas de 18 litros, serão: " + quantidadeDeLatasGrandes + " latas grandes");
		System.out.println("O custo total será de R$ " + custoTotalLatasGrandes);
		...
		System.out.println("Em latas de 3,6 litros, serão: " + quantidadeDeLatasPequenas + " latas pequenas");
		System.out.println("O custo total será de R$ " + custoTotalLatasPequenas);
